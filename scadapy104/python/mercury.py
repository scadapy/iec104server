...
def getP(netAdr,ser):
     try:
         ...
         P  =int((reqString[1] & (~(1 << 7))) & (~(1 << 6))<<16) +  int(reqString[3]<<8) + int(reqString[2])
         if( bt1[0] == '1'): P = P * -1   #   0x80 
         P1  =int((reqString[4] & (~(1 << 7))) & (~(1 << 6))<<16) +  int(reqString[6]<<8) + int(reqString[5])
         if( bt4[0] == '1'): P1 = P1 * -1   #   0x80 
         P2  = int((reqString[7] & (~(1 << 7))) & (~(1 << 6))<<16) +  int(reqString[9]<<8) + int(reqString[8])
         if( bt7[0] == '1'): P2 = P2 * -1   #   0x80 
         P3  =int((reqString[10] & (~(1 << 7))) & (~(1 << 6))<<16) +  int(reqString[12]<<8) + int(reqString[11])
